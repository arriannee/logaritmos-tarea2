...
// Función para probar Dijkstra con heap binario 
void testDijkstraWithHeap(int i, int j) {
    const int numExperiments = 50;
    ofstream timingFile("tiempos_dijkstra_heap.txt", ios::app); // Abre en modo append para no sobrescribir (aka: muchos archivos!)

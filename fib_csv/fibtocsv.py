...
with open('tiempos_dijkstra_fibonacci.txt', 'r') as file:
    lines = file.readlines()

# Abre el archivo CSV para escribir
with open('tiempos_fibonacci_2e10.csv', 'w') as csv_file:
    # Cabecera
    ...
    for i, line in enumerate(lines[:150]):
        ...
        aristasAux = parts[9][:-1]  # parts[9] corresponde a aristas
        aristas = int(aristasAux[0]) ** int(aristasAux[2]+aristasAux[3]) # Se eleva 2 al exponente correspondiente, 16,...,18
        tiempo = parts[10]  # parts[10] corresponde a tiempo  
        # Escribe la línea en el archivo CSV
        csv_file.write(f'{aristas},{tiempo}\n')

print("Archivo tiempos_fibonacci_2e10.csv generado exitosamente.")

#Para v = 2^12

# Abre el archivo CSV para escribir
with open('tiempos_fibonacci_2e12.csv', 'w') as csv_file:
    # Cabecera
    csv_file.write('aristas,tiempo\n')
...
print("Archivo tiempos_fibonacci_2e12.csv generado exitosamente.")

# Para v = 2^14

# Abre el archivo CSV para escribir
with open('tiempos_fibonacci_2e14.csv', 'w') as csv_file:
    # Cabecera
    csv_file.write('aristas,tiempo\n')
...
print("Archivo tiempos_fibonacci_2e14.csv generado exitosamente.")

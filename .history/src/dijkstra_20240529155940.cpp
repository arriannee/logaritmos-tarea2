...
void dijkstraWithFibonacci(Graph& graph, int root) {
    unordered_map<int, FibonacciNode*> nodeMap; // Usar unordered_map para mayor eficiencia
    FibonacciHeap fibHeap; // Cola de Fibonacci

    unordered_map<int, double> distances; // Usar unordered_map para distancias
    unordered_map<int, int> previous; // Usar unordered_map para nodos previos
...
void testDijkstraWithFibonacci() {
    ...
    Graph grafo2 = construirGrafo(2^10, 2^12);

...
void testDijkstraWithFibonacci(int i, int j) {
    ...
    ofstream timingFile("tiempos_dijkstra_fibonacci.txt", ios::app); // Abre en modo append para no sobrescribir (aka: muchos archivos!)
    ...
    if (timingFile.is_open()) {
        for (int experiment = 0; experiment < numExperiments; ++experiment) {
            ...
            // Imprimir resultados de Dijkstra en archivos separados (comentado pq se llena de archivos)

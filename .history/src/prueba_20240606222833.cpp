...
void testDijkstraWithFibonacci(int i, int j) {
    ...
    ofstream timingFile("tiempos_dijkstra_fibonacci.txt");
    ...
    if (timingFile.is_open()) {
        for (int experiment = 0; experiment < numExperiments; ++experiment) {
            ...
            timingFile << "Experimento " << experiment + 1 << ": " << elapsed.count() << " segundos\n";

            // Imprimir resultados de Dijkstra en archivos separados
            string filename = "resultados_dijkstra_fibonacci_" + to_string(experiment + 1) + ".txt";
...
int main() {
    vector<pair<int, int>> configuraciones = {{10, 16}, {10, 18}, {12, 16}, {12, 18}, {12, 20}, {12, 22}, {14, 16}, {14, 18}, {14, 20}, {14, 22}};

...
with open('tiempos_heap_2e10.csv', 'w') as csv_file:
    # Cabecera
...
print("Archivo tiempos_heap_2e10.csv generado exitosamente.")

#Para v = 2^12

# Abre el archivo CSV para escribir
with open('tiempos_heap_2e12.csv', 'w') as csv_file:
    # Cabecera
    csv_file.write('aristas,tiempo\n')
...
print("Archivo tiempos_heap_2e12.csv generado exitosamente.")

# Para v = 2^14

# Abre el archivo CSV para escribir
with open('tiempos_heap_2e14.csv', 'w') as csv_file:
    # Cabecera
    csv_file.write('aristas,tiempo\n')
...
print("Archivo tiempos_heap_2e14.csv generado exitosamente.")

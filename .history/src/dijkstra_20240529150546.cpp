...
void testDijkstraWithFibonacciGrande() {
    int numeroi = 1024; // Ejemplo: 2^10 = 1024 nodos
    int numeroj = 4096; // Ejemplo: 2^12 = 4096 aristas
    Graph grafo = construirGrafo(numeroi, numeroj);
...
int main() {
    cout << "PRUEBA 1: Grafo pequeño \n";
    testDijkstraWithFibonacci(); // Llamar a la función de prueba
    cout << "PRUEBA 2 \n";
    testDijkstraWithFibonacciGrande();
    cout << "FIN";
    return 0;
}